        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-4">
                <div class="card product-card">
                    <img src="images/300x300.jpeg" class="card-img-top" alt="White Mug">
                    <div class="card-body">
            ...
            <div class="col-md-3 mb-4">
                <div class="card product-card">
                    <img src="images/300x300.jpeg" class="card-img-top" alt="Colour Mug">
                    <div class="card-body">
            ...
            <div class="col-md-3 mb-4">
                <div class="card product-card">
                    <img src="images/300x300.jpeg" class="card-img-top" alt="Magic Mug">
                    <div class="card-body">
            ...
            <div class="col-md-3 mb-4">
                <div class="card product-card">
                    <img src="images/300x300.jpeg" class="card-img-top" alt="Photo Frame">
                    <div class="card-body">
            ...
            <div class="col-md-3 mb-4">
                <div class="card product-card">
                    <img src="images/300x300.jpeg" class="card-img-top" alt="Mouse Pad">
                    <div class="card-body">
            ...
            <div class="col-md-3 mb-4">
                <div class="card product-card">
                    <img src="images/300x300.jpeg" class="card-img-top" alt="Bottle Print">
                    <div class="card-body">
            ...
            <div class="col-md-3 mb-4">
                <div class="card product-card">
                    <img src="images/300x300.jpeg" class="card-img-top" alt="T-shirt Print">
                    <div class="card-body">
            ...
            <div class="col-md-3 mb-4">
                <div class="card product-card">
                    <img src="images/300x300.jpeg" class="card-img-top" alt="Cap Print">
                    <div class="card-body">
